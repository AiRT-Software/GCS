...
public class FileBrowserInterface : MonoBehaviour {
    ...
    //[Range(0.0f, 200.0f)]
    public int ItemButtonHeight = Screen.height/8;

    // Font size used for the directory and file buttons
    [Range(0.0f, 72.0f)]
    public int ItemFontSize = Screen.height/24;

    // Font size used for the path, load and save text
    [Range(0.0f, 72.0f)]
    public int PanelTextFontSize = 24;
    ...
    protected void SetButtonParentHeight(GameObject parent, int height)
    {
        ...
        cellSize = new Vector2(Screen.width * 0.45f, height);
